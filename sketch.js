...
function setup() {
  ...
  gameOver = createSprite(375,height - 120);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(375,height - 60);
...
function draw() {
  //trex.debug = true;
  background(255);
  text("Score: "+ score, 500,height - 150);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(775,height - 80,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(775,height - 35,10,40);
    //obstacle.debug = true;
